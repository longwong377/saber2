...
export const READY_GUARD = {
  third: { x: 0.30, y: 0.08 },
  /* NO STAFF ROW YET. A pitched-up staff rest keeps its low blade out of
   * the legs but costs it the reach and follow-up the saberforms suite pins;
   * the plumbing (`setViewMode(fp, set)`) is in place for a rest that does
   * both. Until then the staff rests like a single blade. */
