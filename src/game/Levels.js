...
/* THE TWO SHIP GROUNDS ARE GONE AGAIN, and the sentence above about interiors
 * is a statement of fact once more. The Boarding Bay and the Providence were
 * built on the argument that "the failure the roster was cut on was a BOX, and
 * neither of these is one" — the bay has no fourth wall and the deck is a ship
 * in plan. The argument was sound and the player played them anyway: "I just
 * tried the boarding bay and the providence and hated them, you completely
 * missed the ball so just remove them. your outside work is much better."
